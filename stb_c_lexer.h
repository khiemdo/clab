...
#define STB_C_LEX_EqualsToken_ARROW       N   //  "=>"  CLEX_eqarrow
...
enum
{
   ...
   STB_C_LEX_EqualsToken_ARROW(    CLEX_eqarrow       )
   ...
   switch (*p) {
      ...
      case '=':
         if (p+1 != lexer->eof) {
            ...
            STB_C_LEX_EqualsToken_ARROW(  if (p[1] == '>') return stb__clex_token(lexer, CLEX_eqarrow, p,p+1);)
         }
         goto single_char;
      case '!':
